...
// var mailTransport = nodemailer.createTransport('smtps://%40gmail.com:<password>@smtp.gmail.com');

// TODO(DEVELOPER): Change the two placeholders below.
// [START initialize]
// Initialize the app with a service account, granting admin privileges
var serviceAccount = require("./genesis-3aa93-firebase-adminsdk-3sell-14f793d66c.json");

firebase.initializeApp({
  credential: firebase.credential.cert(serviceAccount),
  databaseURL: 'https://genesis-3aa93.firebaseio.com'
});
// [END initialize]
