...
import * as import80 from './app.component.ngfactory';
...
import * as import89 from '@angular/core/src/error_handler';
import * as import90 from '@angular/platform-browser/src/dom/dom_tokens';
import * as import91 from '@angular/platform-browser/src/dom/animation_driver';
import * as import92 from '@angular/core/src/render/api';
import * as import93 from '@angular/core/src/security';
import * as import94 from '@angular/core/src/change_detection/differs/iterable_differs';
import * as import95 from '@angular/core/src/change_detection/differs/keyvalue_differs';
import * as import96 from '@angular/http/src/interfaces';
import * as import97 from '@angular/http/src/http';
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  get _LOCALE_ID_41():any {
    if ((this.__LOCALE_ID_41 == null)) { (this.__LOCALE_ID_41 = import3._localeFactory(this.parent.get(import81.LOCALE_ID,(null as any)))); }
  ...
  get _APP_ID_49():any {
    if ((this.__APP_ID_49 == null)) { (this.__APP_ID_49 = import82._appIdRandomProviderFactory()); }
  ...
  get _EVENT_MANAGER_PLUGINS_52():any[] {
    if ((this.__EVENT_MANAGER_PLUGINS_52 == null)) { (this.__EVENT_MANAGER_PLUGINS_52 = [
      ...
      new import85.HammerGesturesPlugin(this._HAMMER_GESTURE_CONFIG_51)
    ]
    ); }
    return this.__EVENT_MANAGER_PLUGINS_52;
  }
  get _EventManager_53():import47.EventManager {
    if ((this.__EventManager_53 == null)) { (this.__EventManager_53 = new import47.EventManager(this._EVENT_MANAGER_PLUGINS_52,this.parent.get(import86.NgZone))); }
  ...
  get _RootRenderer_57():any {
    if ((this.__RootRenderer_57 == null)) { (this.__RootRenderer_57 = import87._createConditionalRootRenderer(this._DomRootRenderer_56,this.parent.get(import87.NgProbeToken,(null as any)),this.parent.get(import44.NgProbeToken,(null as any)))); }
  ...
  get _AnimationQueue_60():import51.AnimationQueue {
    if ((this.__AnimationQueue_60 == null)) { (this.__AnimationQueue_60 = new import51.AnimationQueue(this.parent.get(import86.NgZone))); }
  ...
  get _Overlay_81():import65.Overlay {
    if ((this.__Overlay_81 == null)) { (this.__Overlay_81 = new import65.Overlay(this._OverlayContainer_80,this,this._OverlayPositionBuilder_79,this._ApplicationRef_47,this,this.parent.get(import86.NgZone))); }
  ...
  createInternal():import1.AppModule {
    ...
    this._Testability_45 = new import43.Testability(this.parent.get(import86.NgZone));
    this._ApplicationRef__46 = new import44.ApplicationRef_(this.parent.get(import86.NgZone),this.parent.get(import88.Console),this,this._ErrorHandler_43,this,this._ApplicationInitStatus_44,this.parent.get(import43.TestabilityRegistry,(null as any)),this._Testability_45);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import81.LOCALE_ID)) { return this._LOCALE_ID_41; }
    if ((token === import41.NgLocalization)) { return this._NgLocalization_42; }
    if ((token === import89.ErrorHandler)) { return this._ErrorHandler_43; }
    ...
    if ((token === import82.APP_ID)) { return this._APP_ID_49; }
    if ((token === import90.DOCUMENT)) { return this._DOCUMENT_50; }
    if ((token === import85.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_51; }
    ...
    if ((token === import91.AnimationDriver)) { return this._AnimationDriver_55; }
    if ((token === import49.DomRootRenderer)) { return this._DomRootRenderer_56; }
    if ((token === import92.RootRenderer)) { return this._RootRenderer_57; }
    if ((token === import50.DomSanitizer)) { return this._DomSanitizer_58; }
    if ((token === import93.Sanitizer)) { return this._Sanitizer_59; }
    if ((token === import51.AnimationQueue)) { return this._AnimationQueue_60; }
    if ((token === import52.ViewUtils)) { return this._ViewUtils_61; }
    if ((token === import94.IterableDiffers)) { return this._IterableDiffers_62; }
    if ((token === import95.KeyValueDiffers)) { return this._KeyValueDiffers_63; }
